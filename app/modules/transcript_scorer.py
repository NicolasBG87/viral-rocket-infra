...
class TranscriptScorer:
    ...
    def score(self) -> float:
        try:
            ...
            hype_words = {"insane", "omg", "crazy", "wtf", "bro", "cheater", "legit", "clutch", "fucking", "laugh",
                          "go", "run", "sick", "god"}
            hype_count = sum(
            ...
            logger.info(
                f"📊 Transcript scoring: WPM={wpm:.1f}, Hype={hype_count}, Long Gaps={long_gaps}, Score={score:.2f}")
